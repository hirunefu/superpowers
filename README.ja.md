...
> 未改変の上流プラグインや、他のハーネス（Codex / Gemini / OpenCode / Cursor /
> Copilot）が必要ですか？
...
Superpowers がお金になる何かの役に立ち、そうしたいと思ってもらえるなら、[Jesse 氏のオープンソース活動へのスポンサー](https://github.com/sponsors/obra) をぜひご検討ください。
